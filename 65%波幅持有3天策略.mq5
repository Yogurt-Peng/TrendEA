...
input double InpLotSize = 0.05;                       // 交易手数
input int exitDays = 5; // 持有天数
// 振幅
input double InpWave = 0.75;

input int InpEMAFast = 9;                            // 慢速EMA
input int InpEMASlow = 16;                           // 快速EMA
...
public:
  ...
  SignalType TradeSignal() override
    ...
    void ExecuteTrade() override
    {
        ...
        if(m_EntryTime+exitDays*24*3600 < TimeCurrent())
        {
